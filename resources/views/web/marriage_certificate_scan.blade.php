  ...
  <body>
      ...
      <section class="">
        <div class="container-fluid px-0 py-2 ">
            <div class="marrige" style="width:100% !important">
                <div class="row">
                    ...
                    <div class="row marriage_flex">
                        <div class="col-6">
                           ...
                           <div class="row mb-1">
                                ...
                                <div class="col-5 px-0">
                                    <div class="bio_data">
                                          <p>लक्ष्मणप्रसाद पृथ्वीचंद गुप्ता</p>
                                    </div>
                                </div>
                           </div>
                           <!-------------------------------->
    ...
    <!--      <h3 class="" style="color:blue;">{{ $details->panchayat->name_mr }}, {{ $details->panchayat->address_mr }}</h3>-->
    <!--      <h3 class="" style="color:blue;">{{ $details->panchayat->name}},{{ $details->panchayat->address}}</h3>-->
    <!--    </div>-->
    <!--    <div class="row">-->
    <!--      <div class="col-9">-->
    ...
    <!--              <img src="{{ asset('certificate_css/images/national-symbol.png') }}" class="img-fluid main-img">-->
    <!--            </div>-->
    <!--          </div>-->
    <!--          <div class="col-9">-->
    ...
    <!--                <div class="py-1">-->
    <!--                  <h1 class="fw-bold" style="color:green;">विवाह नोंद प्रमाणपत्र</h1>-->
    <!--                  <h1 class="fw-bold" style="color:green; font-size:16px !important ">MARRIAGE CERTIFICATE</h1>-->
    <!--                </div>-->
    <!--              </div>-->
    <!--            </div>-->
    <!--          </div>-->
    ...
    <!--        <p class="fw-bold">THIS IS TO CERTIFY THAT, THE FOLLOWING INFORMATION HAS BEEN TAKEN FROM THE ORIGINAL MARRIAGE RECORDS REGISTER OF GRAMPANCHAYAT {{ $details->panchayat->name}}, {{ $details->panchayat->address}}, STATE MAHARASHTRA.</p>-->
    <!--        </div>-->
    <!--      </div>-->
    <!--      <div class="col-3" style="margin-left: -10px;">-->
    <!--         <div class="blank-img-box mt-2"><img src="{{ asset($details->groom_image) }}" alt="Groom Image" class="img-fluid client-image"></div>-->
    <!--        <div class="blank-img-box mt-2"><img src="{{ asset($details->bride_image) }}" alt="Bride Image" class="img-fluid client-image"></div>-->
    <!--      </div>-->
    <!--    </div>-->
    ...
    <!--            <div class="row">-->
    <!--              <div class="col-5">-->
    <!--                <p class="text-nowrap">वराच्यया वडीलाचे/पालकाचे नांव व</p>-->
    <!--              </div>-->
    <!--              <div class="col-7">-->
    <!--                <p>{{ $details->groom_gurdian_name_mr }}</p>-->
    <!--              </div>-->
    ...
    <!--            <div class="row">-->
    <!--              <div class="col-8">-->
    <!--                <p class="text-nowrap">GROOM FATHER'S/GUARDIANS NAME & </p>-->
    <!--              </div>-->
    <!--              <div class="col-4">-->
    ...
    <!--            <div class="row">-->
    <!--              <div class="col-3">-->
    <!--                <p class="text-nowrap">वधुच्या वडीलाचे/पालकाचे नांव व</p>-->
    <!--              </div>-->
    <!--              <div class="col-9">-->
    ...
    <!--            <div class="row">-->
    <!--              <div class="col-5">-->
    <!--                <p class="text-nowrap">BRIDE FATHER'S/GUARDIANS NAME & </p>-->
    <!--              </div>-->
    <!--              <div class="col-7">-->
    ...
    <!--            <div class="row">-->
    <!--              <div class="col-7">-->
    <!--                <p class="text-nowrap">विवाह दिनांक :</p>-->
    <!--              </div>-->
    <!--              <div class="col-5">-->
    <!--                <p class="fw-bold text-nowrap">{{ GoogleTranslate::trans($details->date_of_marriage, 'mr') }}</p>-->
    <!--              </div>-->
    <!--            </div>-->
    <!--            <div class="row mt-1">-->
    <!--              <div class="col-7">-->
    <!--                <p class="text-nowrap">DATE OF MARRIAGE :</p>-->
    <!--              </div>-->
    <!--              <div class="col-5">-->
    <!--                <p class="-fw-bold text-nowrap">{{ $details->date_of_marriage}}</p>-->
    <!--              </div>-->
    <!--            </div>-->
    ...
    <!--            <div class="row mt-1">-->
    <!--              <div class="col-7">-->
    <!--                <p class="text-nowrap">REGIST NUMBER :</p>-->
    <!--              </div>-->
    <!--              <div class="col-5">-->
    ...
    <!--              </div>-->
    <!--              <div class="col-5">-->
    <!--                <p class="fw-bold">{{ GoogleTranslate::trans($details->registration_date, 'mr') }}</p>-->
    <!--              </div>-->
    <!--            </div>-->
    ...
    <!--              </div>-->
    <!--              <div class="col-5">-->
    <!--                <p class="-fw-bold text-nowrap">{{ $details->registration_date}}</p>-->
    <!--              </div>-->
    <!--            </div>-->
