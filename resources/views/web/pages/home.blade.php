...
जुनी नोंदणी प्रत मोबाईलवर उपलब्ध आहे. तुम्हाला पुन्हा पुन्हा नोंदणी रजिस्टरमध्ये जाण्याची गरज नाही.</p>
      </div>
    </div>
  </div>
  <div class="item">
  ...
  <section class="main-section container margin-top">
    ...
    <div class="row">
    <div class="col-md-9">
    <img src="{{asset('web/assets/images/about-section.jpg')}}" class="img-fluid" alt="online-payment">
    </div>
    <div class="col-md-3">
...
सर्व आवश्यक कागदपत्रे एकाच छताखाली ग्रामपंचायत नमुना क्र. 8, 9. ग्रामपंचायतीमधील जुन्या नोंदी सुरक्षित करणे, दस्तऐवज व्यवस्थापन, डेटा प्रोसेसिंग, आजीवन डेटा सेव्हिंग, जन्म, मृत्यू, विवाह, बुक बाइंडिंग, जुन्या रेकॉर्डचे स्कॅनिंग. अचूक जन्म, मृत्यू, विवाह रेकॉर्ड स्कॅन कॉपी एका क्लिकवर उपलब्ध, इ........<span class="text-primary"> <a href="{{route('webview.aboutus')}}">अधिक पहा</a></span></p>
    </div>
    </div>
    ...
    <!-- Carousel -->
    <section class="container second-crousel margin-top">
