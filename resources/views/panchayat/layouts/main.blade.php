...
<body class="bg-theme bg-theme2">
    <!--wrapper-->
    <div class="wrapper">
        @include('panchayat.layouts.sidebar')

        @include('panchayat.layouts.header')

        <!-- Left side column. contains the logo and sidebar -->

        @yield('content')
        @include('panchayat.layouts.footer')
        @include('panchayat.layouts.theme')
        ...
        @include('panchayat.layouts.validation')
        <script>
        ...
        const keyboard = new SimpleKeyboard.default({
            ...
            layout: {
                'default': [
                                ...
                                'प फ ब भ म य र ल व श',
                                'ष स ह ळ क्ष त्र ज्ञ',
                                '{space} ि ी ु ू ृ े ै ो ौ ं ः ा ्'
                             ]
            },
            display: {
                '{bksp}': '⌫',
...
<style>
    .simple-keyboard {
        display: none; /* Hide the keyboard by default */
        z-index: 1000; /* Ensure the keyboard appears above other content */
    }
</style>
