...
@section('title', 'Healthtax Due Payment Create')
@section('content')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h2>Create Home Tax Payment</h2>

                            <form action="{{ route('panchayat.healthtaxes.due.store', $healthtax->id) }}" method='Post'>
                                @csrf
                                {{-- <div class="mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="property_name" value="{{$healthtax->property->property_name}}"
                                    class="form-control" disabled>
                                <div class="form-group">
                                    <label for="year">Payment Year</label>
                                    <input type="text"  name="year" value="{{$healthtax->year}}"
                                    class="form-control" disabled>
                                ...
                                <div class="form-group">
                                    <label for="given_tax_amount">Health Tax Amount</label>
                                    <input type="number" step="0.01" name="pay_tax_amount" value=""
                                           class="form-control" required>
                                </div>
