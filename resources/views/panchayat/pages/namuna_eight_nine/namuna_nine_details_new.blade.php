    ...
    <table class="table table-bordered table-striped mt-4">
      <thead class="table-dark text-center">
        ...
        <tr>
          ...
          <th  rowspan="2">Before 30 Sep.</th>
          <th  rowspan="2">After 30 Sep.</th>

          <th  rowspan="2">पावती क्र. / Reciept no.</th>
          <th  rowspan="2">पावती तारीख / Reciept date</th>
