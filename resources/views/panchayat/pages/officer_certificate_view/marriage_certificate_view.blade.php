    ...
    <section class="container d-flex justify-content-center">
        <div class="form-body">
            <div class="pt-2 death-form text-center">
                <h3 class="">{{ $details->panchayat->name_mr }},
                    {{ $details->panchayat->address_mr }}</h3>
                <h3 class=" fst-italic">{{ $details->panchayat->name }},{{ $details->panchayat->address }}</h3>
            </div>
            <div class="row">
                <div class="col-9">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="pt-2 death-form d-flex justify-content-center text-center">
                                <div class="m-0">
                                    <h5 class="fw-bold">नमुना ड</h5>
                                    <h5 class="fw-bold fst-italic">FORM D</h5>
                                    ...
                                    <div class="py-1">
                                        <h1 class="fw-bold">विवाह नोंद प्रमाणपत्र</h1>
                                        <h1 class="fw-bold">MARRIAGE CERTIFICATE</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-3">
                    <!--<div class="blank-img-box mt-2"><img src="{{ asset('certificate_css/images/download.png') }}" class="img-fluid client-image"></div>-->
                    <!--<div class="blank-img-box mt-2"><img src="{{ asset('certificate_css/images/download.png') }}" class="img-fluid client-image"></div>-->
                    <!--<div class="blank-img-box mt-2"><img src="{{ asset('storage/' . $details->bride_image) }}" alt="" class="img-fluid client-image"></div>-->
                    <div class="blank-img-box mt-2"><img src="{{ asset($details->groom_image) }}" alt="Groom Image"
                            class="img-fluid client-image"></div>
                    <div class="blank-img-box mt-2"><img src="{{ asset($details->bride_image) }}" alt="Bride Image"
                            class="img-fluid client-image"></div>
                </div>
            </div>
            <div class="container certificate">
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-5 mt-2">
                        {!! QrCode::size(100)->generate('https://smartgram.fusiontechlab.site/marriageCertificate/' . $details->id) !!}
                    </div> --}}
                </div>
                ...
                <div class="row">
                    ...
                    {{-- @if($officer->digital_signature)
                        <div class="col-5">
                            <img src="{{ asset($officer->digital_signature) }}" alt="Officer-signature" height="30px"
                                width="110px">
