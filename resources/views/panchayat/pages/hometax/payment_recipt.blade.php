        ...
        <div class="container">
            ...
            <div class="col-12">
                <div class="gram_bio mt-4">
                    <p class="mb-4">Grampanchayat <span>{{$tax['panchayat_address_mr']}}</span></p>
                    <p style="text-align:right">
                        Receipt Number by : <span>{{$tax['recipt_id']}}</span> 
                    </p>
                         <p style="text-align:justify">Received from mrs/miss/mr. <span>{{$tax['owner_name_mr']}}</span> Property Number <span>{{$tax['property_no']}}</span> Year <span>{{$tax['year']}}</span> The following amounts were received as tax for.
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 mt-4">
                ...
                <table class="table table-bordered text-center table-hover">
                    ...
                    <tbody>
                        ...
                        <th>Total</th>
                        <td></td>
                        <td><b> {{ $tax['home_pay_tax_amount'] ?? 0.00 }} </b></td>
                        <td></td>
                        </tr>
                    </tbody>
                </table>
                <p>
                    Amount inword : <span style="border-bottom:1px dotted"><b>{{ $tax['home_pay_tax_amount_in_word']  }}</b> rupess only</span> Received.
                </p>
                <div class="mt-4 d-flex justify-content-between">
                    <p>Date <span style="border-bottom:1px dotted;">{{ $tax['created_at'] }}</span></p>
                    <div class="mt-4">
                        <img src="" alt="">
