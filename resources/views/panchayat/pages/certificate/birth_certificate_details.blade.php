...
<section class="body">
  ...
  <!--              <div class="row mt-1 right_side">-->
  <!--                  <div class="col-6">-->
  <!--                      <div class="row">-->
  <!--                          <div class="col-7">-->
  <!--                              <p>जन्म दिनाक :</p>-->
  <!--                          </div>-->
  <!--                          <div class="col-5 all_del">-->
  <!--                              <p>{{ $details->dob }}</p>-->
  <!--                          </div>-->
  <!--                      </div>-->
  ...
  <!--     <div style="position:absolute; right:80px;" class="qrcode">-->
  ...
  <!--                      </div>-->
                        ...
                        <!--        <img src="{{ asset( $officer->digital_signature) }}" alt="Officer-signature"style="object-fit: cover; height:70px; width:70px;vertical-align: none;" class="signature">-->
                        <!--        <br>-->
