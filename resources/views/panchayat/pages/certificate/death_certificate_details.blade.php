...
<body>
    <section class="body">
    <section class="container-fluid px-0 d-flex justify-content-center" id ="content">
        <div class="form-body">
...
<!----------------------------------------------->
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-4 px-0 ">
                            <p>{{ $details->registration_date_mr }}</p>
                        </div>
                    </div>
                    <!--------------------------------------->
                    <div class="row mb-1">
    ...
    <div class="d-flex justify-content-center py-5">
        <button class="btn btn-primary no-print" id="print">Print Certificate</button>
    </div>
    </section>
    <script>
