...
@section('title', 'Lamptax Due Payment Create')
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Lamptax</div>
                <div>
            ...
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h2>Create Lamp Tax Payment</h2>

                            <form action="{{ route('panchayat.lamptaxes.due.store', $lamptax->id) }}" method='Post'>
                                @csrf
                                {{-- <div class="mb-3">
                                ...
                                <div class="form-group">
                                    <label for="year">Name Of the Property</label>
                                    <input type="text"  name="property_name" value="{{$lamptax->property->property_name}}"
                                    class="form-control" disabled>
                                <div class="form-group">
                                    <label for="year">Payment Year</label>
                                    <input type="text"  name="year" value="{{$lamptax->year}}"
                                    class="form-control" disabled>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="pay_tax_amount" value=""
                                           class="form-control" required>
                                </div> --}}

                                <div class="form-group">
                                    <label for="given_tax_amount">Lamp Tax Amount</label>
                                    <input type="number" step="0.01" name="pay_tax_amount" value=""
                                           class="form-control" required>
                                </div>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="home_pay_tax_amount"
                                        value="{{ old('home_pay_tax_amount') }}" class="form-control" required>
                                </div> --}}
