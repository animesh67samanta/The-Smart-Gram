...
@section('title', 'Lamptax Payment Create')
@section('content')
                ...
                <div class="col-xl-9 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('panchayat.lamptaxes.payment.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="total_lamp_tax"
                                          value="{{ old('total_lamp_tax') }}"
                                           class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label for="given_tax_amount">Pay Tax Amount</label>
                                    <input type="number"  name="pay_tax_amount"
